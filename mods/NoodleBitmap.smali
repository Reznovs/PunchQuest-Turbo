.class public Lcom/noodlecake/lib/font/NoodleBitmap;
.super Ljava/lang/Object;
.source "NoodleBitmap.java"


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/noodlecake/lib/font/NoodleBitmap$TextProperty;
    }
.end annotation
...
.method private static computeTextProperty(Ljava/lang/String;Landroid/graphics/Paint;II)Lcom/noodlecake/lib/font/NoodleBitmap$TextProperty;
    .locals 11
    ...
    invoke-static {p0, p3, p2, p1}, Lcom/noodlecake/lib/font/NoodleBitmap;->splitString(Ljava/lang/String;IILandroid/graphics/Paint;)[Ljava/lang/String;
    ...
    .line 166
    :cond_0
    new-instance v6, Lcom/noodlecake/lib/font/NoodleBitmap$TextProperty;

    invoke-direct {v6, v4, v1, v3}, Lcom/noodlecake/lib/font/NoodleBitmap$TextProperty;-><init>(II[Ljava/lang/String;)V
...
.method public static createTextBitmap(Ljava/lang/String;Ljava/lang/String;IIII)V
    ...
    .prologue
    .line 72
    invoke-static/range {p0 .. p0}, Lcom/noodlecake/lib/font/NoodleBitmap;->refactorString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    .line 73
    invoke-static/range {p1 .. p3}, Lcom/noodlecake/lib/font/NoodleBitmap;->newPaint(Ljava/lang/String;II)Landroid/graphics/Paint;
    ...
    invoke-static {v0, v9, v1, v2}, Lcom/noodlecake/lib/font/NoodleBitmap;->computeTextProperty(Ljava/lang/String;Landroid/graphics/Paint;II)Lcom/noodlecake/lib/font/NoodleBitmap$TextProperty;

    move-result-object v10

    .line 77
    .local v10, "textProperty":Lcom/noodlecake/lib/font/NoodleBitmap$TextProperty;
    if-nez p5, :cond_0

    iget v4, v10, Lcom/noodlecake/lib/font/NoodleBitmap$TextProperty;->totalHeight:I

    .line 80
    .local v4, "bitmapTotalHeight":I
    :goto_0
    iget v13, v10, Lcom/noodlecake/lib/font/NoodleBitmap$TextProperty;->maxWidth:I
    ...
    .local v12, "y":I
    :goto_1
    iget-object v8, v10, Lcom/noodlecake/lib/font/NoodleBitmap$TextProperty;->lines:[Ljava/lang/String;
    ...
    .line 96
    invoke-static {v3}, Lcom/noodlecake/lib/font/NoodleBitmap;->initNativeObject(Landroid/graphics/Bitmap;)V
    ...
    iget v14, v10, Lcom/noodlecake/lib/font/NoodleBitmap$TextProperty;->totalHeight:I
    ...
    iget v15, v10, Lcom/noodlecake/lib/font/NoodleBitmap$TextProperty;->maxWidth:I

    move/from16 v0, p3

    invoke-static {v9, v7, v15, v0}, Lcom/noodlecake/lib/font/NoodleBitmap;->computeX(Landroid/graphics/Paint;Ljava/lang/String;II)I
    ...
    .line 93
    iget v15, v10, Lcom/noodlecake/lib/font/NoodleBitmap$TextProperty;->heightPerLine:I
...
.method private static initNativeObject(Landroid/graphics/Bitmap;)V
    ...
    .prologue
    .line 370
    invoke-static {p0}, Lcom/noodlecake/lib/font/NoodleBitmap;->getPixels(Landroid/graphics/Bitmap;)[B
    ...
    invoke-static {v1, v2, v0}, Lcom/noodlecake/lib/font/NoodleBitmap;->nativeInitBitmapDC(II[B)V
...
.method private static newPaint(Ljava/lang/String;II)Landroid/graphics/Paint;
    ...
    # ====== 字体自适应：优先使用系统默认字体（天然支持中文 CJK）======
    # 原代码优先加载 .ttf 文件，如果 .ttf 不支持中文则中文显示为方块
    # 修改：始终先设置 Android 系统 DEFAULT 字体作为 fallback
    # 这样当 .ttf 字体不包含所需字符时，Paint 会自动 fallback 到系统字体
    ...
    :cond_0
    :try_start_0
    sget-object v3, Lcom/noodlecake/lib/font/NoodleBitmap;->context:Landroid/content/Context;

    invoke-static {v3, p0}, Lcom/noodlecake/lib/font/NoodleTypefaces;->get(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Typeface;
...
.method public static setContext(Landroid/content/Context;)V
    ...
    .prologue
    .line 62
    sput-object p0, Lcom/noodlecake/lib/font/NoodleBitmap;->context:Landroid/content/Context;
...
.method private static splitString(Ljava/lang/String;IILandroid/graphics/Paint;)[Ljava/lang/String;
    ...
    invoke-static {v0, v5, v1}, Lcom/noodlecake/lib/font/NoodleBitmap;->divideStringWithMaxWidth(Landroid/graphics/Paint;Ljava/lang/String;I)Ljava/util/LinkedList;
